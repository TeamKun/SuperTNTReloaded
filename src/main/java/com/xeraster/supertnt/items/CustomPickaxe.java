...
public class CustomPickaxe extends ItemTool {
    ...
    public CustomPickaxe(ToolMaterial material, String idName) {
        super(1.0F, -2.8F, material, CustomPickaxe.EFFECTIVE_ON);
