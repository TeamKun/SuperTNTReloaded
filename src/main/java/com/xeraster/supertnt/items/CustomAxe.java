...
public class CustomAxe extends ItemTool {
    ...
    public CustomAxe(ToolMaterial material, String idName, float damage, float speed) {
        super(material, CustomAxe.EFFECTIVE_ON);
        this.setRegistryName(idName);
        this.setUnlocalizedName(idName);
        this.attackDamage = CustomAxe.ATTACK_DAMAGES[material.ordinal()];
        this.attackSpeed = CustomAxe.ATTACK_SPEEDS[material.ordinal()];
