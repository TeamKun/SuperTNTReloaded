...
public class EntityTNTTimePrimed extends Entity {

    private static final DataParameter FUSE = EntityDataManager.createKey(EntityTNTTimePrimed.class, DataSerializers.VARINT);
    @Nullable
    private EntityLivingBase tntPlacedBy;
    private int fuse;

    public EntityTNTTimePrimed(World worldIn) {
        super(worldIn);
        this.fuse = 80;
    ...
    public EntityTNTTimePrimed(World worldIn, double x, double y, double z, EntityLivingBase igniter) {
        this(worldIn);
    ...
    protected void entityInit() {
        this.dataManager.register(EntityTNTTimePrimed.FUSE, Integer.valueOf(80));
    }
    ...
    private void explode() {
        ITextComponent setToDay = Serializer.fromJsonLenient("\'Making it §e§ldaytime.\'");
        ITextComponent setToNight = Serializer.fromJsonLenient("\'Making it §5§lnighttime§r. Time to go to sleep.\'");
        ...
        if (!this.world.isDaytime()) {
            ...
            Minecraft.getMinecraft().player.sendMessage(setToDay);
        } else if (this.world.isDaytime()) {
            this.world.setWorldTime(13000L);
            Minecraft.getMinecraft().player.sendMessage(setToNight);
        }
    ...
    public void setFuse(int fuseIn) {
        this.dataManager.set(EntityTNTTimePrimed.FUSE, Integer.valueOf(fuseIn));
        this.fuse = fuseIn;
    }

    public void notifyDataManagerChange(DataParameter key) {
        if (EntityTNTTimePrimed.FUSE.equals(key)) {
    ...
    public int getFuseDataManager() {
        return ((Integer) this.dataManager.get(EntityTNTTimePrimed.FUSE)).intValue();
    }
