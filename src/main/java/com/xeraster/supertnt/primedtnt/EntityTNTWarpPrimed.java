...
import com.xeraster.supertnt.explosions.WarpExplosion;
...
public class EntityTNTWarpPrimed extends Entity {

    private static final DataParameter FUSE = EntityDataManager.createKey(EntityTNTWarpPrimed.class, DataSerializers.VARINT);
    @Nullable
    private EntityLivingBase tntPlacedBy;
    private int fuse;
    EntityLivingBase guyThatIgnitedIt;

    public EntityTNTWarpPrimed(World worldIn) {
        super(worldIn);
        this.fuse = 80;
    ...
    public EntityTNTWarpPrimed(World worldIn, double x, double y, double z, EntityLivingBase igniter) {
        this(worldIn);
    ...
    public WarpExplosion createExplosion(@Nullable Entity entityIn, double x, double y, double z, float strength, boolean isSmoking) {
        return this.newExplosion(entityIn, x, y, z, strength, false, isSmoking);
    }

    public WarpExplosion newExplosion(@Nullable Entity entityIn, double x, double y, double z, float strength, boolean isFlaming, boolean isSmoking) {
        WarpExplosion explosion = new WarpExplosion(this.world, entityIn, x, y, z, strength, isFlaming, isSmoking);
    ...
    protected void entityInit() {
        this.dataManager.register(EntityTNTWarpPrimed.FUSE, Integer.valueOf(80));
    }
    ...
    public void setFuse(int fuseIn) {
        this.dataManager.set(EntityTNTWarpPrimed.FUSE, Integer.valueOf(fuseIn));
        this.fuse = fuseIn;
    }

    public void notifyDataManagerChange(DataParameter key) {
        if (EntityTNTWarpPrimed.FUSE.equals(key)) {
    ...
    public int getFuseDataManager() {
        return ((Integer) this.dataManager.get(EntityTNTWarpPrimed.FUSE)).intValue();
    }
