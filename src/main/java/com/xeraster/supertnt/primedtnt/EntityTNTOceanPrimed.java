...
public class EntityTNTOceanPrimed extends Entity {

    private static final DataParameter FUSE = EntityDataManager.createKey(EntityTNTOceanPrimed.class, DataSerializers.VARINT);
    @Nullable
    private EntityLivingBase tntPlacedBy;
    private int fuse;

    public EntityTNTOceanPrimed(World worldIn) {
        super(worldIn);
        this.fuse = 80;
    ...
    public EntityTNTOceanPrimed(World worldIn, double x, double y, double z, EntityLivingBase igniter) {
        this(worldIn);
    ...
    protected void entityInit() {
        this.dataManager.register(EntityTNTOceanPrimed.FUSE, Integer.valueOf(80));
    }
    ...
    public void setFuse(int fuseIn) {
        this.dataManager.set(EntityTNTOceanPrimed.FUSE, Integer.valueOf(fuseIn));
        this.fuse = fuseIn;
    }

    public void notifyDataManagerChange(DataParameter key) {
        if (EntityTNTOceanPrimed.FUSE.equals(key)) {
    ...
    public int getFuseDataManager() {
        return ((Integer) this.dataManager.get(EntityTNTOceanPrimed.FUSE)).intValue();
    }
