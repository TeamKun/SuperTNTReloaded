...
public class EntityTNTFlatPrimed extends Entity {

    private static final DataParameter FUSE = EntityDataManager.createKey(EntityTNTFlatPrimed.class, DataSerializers.VARINT);
    @Nullable
    private EntityLivingBase tntPlacedBy;
    private int fuse;

    public EntityTNTFlatPrimed(World worldIn) {
        super(worldIn);
        this.fuse = 80;
    ...
    public EntityTNTFlatPrimed(World worldIn, double x, double y, double z, EntityLivingBase igniter) {
        this(worldIn);
    ...
    protected void entityInit() {
        this.dataManager.register(EntityTNTFlatPrimed.FUSE, Integer.valueOf(80));
    }
    ...
    public void setFuse(int fuseIn) {
        this.dataManager.set(EntityTNTFlatPrimed.FUSE, Integer.valueOf(fuseIn));
        this.fuse = fuseIn;
    }

    public void notifyDataManagerChange(DataParameter key) {
        if (EntityTNTFlatPrimed.FUSE.equals(key)) {
    ...
    public int getFuseDataManager() {
        return ((Integer) this.dataManager.get(EntityTNTFlatPrimed.FUSE)).intValue();
    }
