...
public class EntityTNTTeleportPrimed extends Entity {

    private static final DataParameter FUSE = EntityDataManager.createKey(EntityTNTTeleportPrimed.class, DataSerializers.VARINT);
    @Nullable
    private EntityLivingBase tntPlacedBy;
    private int fuse;
    EntityLivingBase guyThatIgnitedIt;

    public EntityTNTTeleportPrimed(World worldIn) {
        super(worldIn);
        this.fuse = 80;
    ...
    public EntityTNTTeleportPrimed(World worldIn, double x, double y, double z, EntityLivingBase igniter) {
        this(worldIn);
    ...
    protected void entityInit() {
        this.dataManager.register(EntityTNTTeleportPrimed.FUSE, Integer.valueOf(80));
    }
    ...
    public void setFuse(int fuseIn) {
        this.dataManager.set(EntityTNTTeleportPrimed.FUSE, Integer.valueOf(fuseIn));
        this.fuse = fuseIn;
    }

    public void notifyDataManagerChange(DataParameter key) {
        if (EntityTNTTeleportPrimed.FUSE.equals(key)) {
    ...
    public int getFuseDataManager() {
        return ((Integer) this.dataManager.get(EntityTNTTeleportPrimed.FUSE)).intValue();
    }
