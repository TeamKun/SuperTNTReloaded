...
public class EntityTNTSavePrimed extends Entity {

    private static final DataParameter FUSE = EntityDataManager.createKey(EntityTNTSavePrimed.class, DataSerializers.VARINT);
    @Nullable
    private EntityLivingBase tntPlacedBy;
    private int fuse;

    public EntityTNTSavePrimed(World worldIn) {
        super(worldIn);
        this.fuse = 80;
    ...
    public EntityTNTSavePrimed(World worldIn, double x, double y, double z, EntityLivingBase igniter) {
        this(worldIn);
    ...
    protected void entityInit() {
        this.dataManager.register(EntityTNTSavePrimed.FUSE, Integer.valueOf(80));
    }
    ...
    private void explode() {
        ITextComponent saveMessage = Serializer.fromJsonLenient("\'Your game has been saved. §6Thank you §ffor using §5§lSave TNT!\'");
        ...
        Minecraft.getMinecraft().player.sendMessage(saveMessage);
    }
    ...
    public void setFuse(int fuseIn) {
        this.dataManager.set(EntityTNTSavePrimed.FUSE, Integer.valueOf(fuseIn));
        this.fuse = fuseIn;
    }

    public void notifyDataManagerChange(DataParameter key) {
        if (EntityTNTSavePrimed.FUSE.equals(key)) {
    ...
    public int getFuseDataManager() {
        return ((Integer) this.dataManager.get(EntityTNTSavePrimed.FUSE)).intValue();
    }
