...
public class EntityTNTMassivePrimed extends Entity {
    ...
    public EntityTNTMassivePrimed(World worldIn) {
        super(worldIn);
        this.fuse = 80;
    ...
    public EntityTNTMassivePrimed(World worldIn, double x, double y, double z, EntityLivingBase igniter) {
        this(worldIn);
    ...
    protected void entityInit() {
        this.dataManager.register(EntityTNTMassivePrimed.FUSE, Integer.valueOf(80));
    }
    ...
    public void setFuse(int fuseIn) {
        this.dataManager.set(EntityTNTMassivePrimed.FUSE, Integer.valueOf(fuseIn));
        this.fuse = fuseIn;
    }

    public void notifyDataManagerChange(DataParameter key) {
        if (EntityTNTMassivePrimed.FUSE.equals(key)) {
    ...
    public int getFuseDataManager() {
        return ((Integer) this.dataManager.get(EntityTNTMassivePrimed.FUSE)).intValue();
    }
